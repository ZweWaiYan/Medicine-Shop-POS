            ...
            <div className="w-full max-w-[800px] h-full max-h-[900px] grid md:grid-cols-2 rounded-lg overflow-hidden">
                ...
                <div className="relative bg-blue-500 p-8 text-white flex flex-col items-center justify-center rounded-tr-full">
                    <div className="relative z-10">
                        ...
                        <button onClick={() => navigate("/register")} className="w-full h-[45px]  font-semibold text-white hover:border-2 border rounded-lg">Register</button>
                    </div>
                ...
                <div className="p-8 bg-white">
                    <div className="space-y-6">
                        ...
                        <form onClick={handleLogin} className="space-y-4 flex flex-col items-center justify-center w-full">
